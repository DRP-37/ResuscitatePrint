...
namespace Resuscitate.DataClasses
{
    public class BloodGas : Event
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($"Timing: {time.ToString()}, pH: {pH.ToString()}, Lactate: {lactate.ToString()}, Glucose: {glucose.ToString()} mmol/l, PCO2: {PCO2.ToString()}, Excess: {Excess.ToString()}, Haemoglobin: {Haemoglobin.ToString()} g/l");
